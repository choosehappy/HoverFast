...
def get_args() -> argparse.Namespace:
    ...
    infer_wsi_parser.add_argument("slide_folder", help="input filename pattern.", nargs="+", type=str)
    infer_wsi_parser.add_argument("-o", "--outdir", help="outputdir, default ./output/", default="./output/", type=str)
    ...
    infer_wsi_parser.add_argument("-b", "--binmask_dir", help="quality control mask directory", default=None, type=str)
    infer_wsi_parser.add_argument(
        "-m",
        "--model_path",
    ...
    infer_roi_parser.add_argument("slide_folder", help="input filename pattern.", nargs="+", type=str)
    infer_roi_parser.add_argument("-o", "--outdir", help="outputdir, default ./output/", default="./output/", type=str)
    ...
    infer_roi_parser.add_argument("-r", "--batch_mem", help="maximum batches saves on memory", default=500, type=int)
    infer_roi_parser.add_argument(
        "-g",
        "--batch_gpu",
        help="Target batch size for GPU: +1 in batch ~ +2GB VRAM (for pretrain model). Avoid matching or exceeding estimated GPU VRAM.",
    ...
    infer_roi_parser.add_argument(
        "-w", "--width", help="width of the cells border shown in the overlay", default=2, type=int
    )
    infer_roi_parser.add_argument(
        "-c",
        "--color",
    ...
    train_parser.add_argument(
        "-o", "--outdir", help="output directory path for tensorboard and trained model", default="./output/", type=str
    )
    train_parser.add_argument(
        "-p", "--dataset_path", help="path to the directory that contains the pytables", default="./", type=str
    )
    train_parser.add_argument("-b", "--batch_size", help="number of worker for dataloader", default=5, type=int)
    train_parser.add_argument(
        "-n",
        "--n_worker",
    ...
    train_parser.add_argument("-e", "--epoch", help="number of epoch", default=100, type=int)
    train_parser.add_argument("-d", "--depth", help="depth of the model", default=3, type=int)
    train_parser.add_argument(
        "-w",
        "--width",
